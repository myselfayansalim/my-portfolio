      ...
      <div className="py-6 lg:py-10">
        <AnimatedSection className="mb-6">
          <Link
            href="/experience"
            className={cn(
              "inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground transition-colors mb-4"
            )}
          >
        ...
        <AnimatedSection delay={0.4} className="flex justify-center mt-8">
          <Link
            href="/experience"
            className={cn(
              "inline-flex items-center gap-2 rounded-xl border px-5 py-2 text-sm font-medium transition-colors hover:bg-muted"
            )}
          >
            <Icons.chevronLeft className="h-4 w-4" />
            View All Experience
